...
When <tt>should_be</tt> or <tt>setup_for</tt> is invoked, it searches up the context hierarchy to find a matching shared definition.  You can redefine your shares in ancestor contexts or contexts or at the root (on your TestCase).
