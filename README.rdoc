...
== Finding Shared Functionality

Shared should invocations search up the context hierarchy to find a matching shared definition.  You can redefine your shares in ancestor contexts.
