...
Some quick examples to get you started using Shared Should. The domain is customers renting and purchasing textbooks - as we do at Bookrenter.com.
  ...
  context "Book" do
    context "with an in-stock book" do
      ...
      context "with a rentable book" do
        ...
        ### Use the "available for checkout" shared_should with should_be
...
Sharing whole contexts? No problem.
...
When <tt>should_be</tt> or <tt>setup_for</tt> is invoked, it searches up the context hierarchy to find a matching shared definition.  You can redefine your shares in descendant contexts. Shares defined at the root (on your TestCase) are available in all contexts.

NOTE: if you define a shared setup at the root level, you will need to call <tt>super</tt> if you have a setup instance method for your test.
